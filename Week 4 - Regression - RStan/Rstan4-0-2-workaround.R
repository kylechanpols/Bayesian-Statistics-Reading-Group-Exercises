...
#1. Install RTools 4.0 
#https://cran.r-project.org/bin/windows/Rtools/

#2. Manually Install the latest version of Rstan and Stanheaders:
install.packages(
...
#4. Run the following code to see if a null stan model runs. If it says Compilation Error then Rstan is not installed properly.
