...
Fit a Bayesian Logistic Regression Model, specifying the prior of $\beta \sim N(0,5)$ and $\beta_0 \sim N(0,10)$. Plot the distribution of the $\beta$s. What did you find?
